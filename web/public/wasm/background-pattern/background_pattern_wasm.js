/* @ts-self-types="./background_pattern_wasm.d.ts" */

export class BackgroundPatternRenderer {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        BackgroundPatternRendererFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_backgroundpatternrenderer_free(ptr, 0);
    }
    /**
     * @param {HTMLCanvasElement} canvas
     * @param {HTMLImageElement} source_image
     * @param {string} theme_color
     */
    constructor(canvas, source_image, theme_color) {
        const ptr0 = passStringToWasm0(theme_color, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.backgroundpatternrenderer_new(canvas, source_image, ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0] >>> 0;
        BackgroundPatternRendererFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     ...
     */
    render(timestamp_ms) {
        const ret = wasm.backgroundpatternrenderer_render(this.__wbg_ptr, timestamp_ms);
        if (ret[1]) {
    ...
    resize(width, height, device_pixel_ratio) {
        const ret = wasm.backgroundpatternrenderer_resize(this.__wbg_ptr, width, height, device_pixel_ratio);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
    ...
    set_theme_color(theme_color) {
        const ptr0 = passStringToWasm0(theme_color, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.backgroundpatternrenderer_set_theme_color(this.__wbg_ptr, ptr0, len0);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
}
if (Symbol.dispose) BackgroundPatternRenderer.prototype[Symbol.dispose] = BackgroundPatternRenderer.prototype.free;
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_drawImage_5fc8b618c9b99d05: function() { return handleError(function (arg0, arg1, arg2, arg3, arg4, arg5) {
        ...
        __wbg_naturalHeight_3b959ee87a36b6c8: function(arg0) {
        ...
        __wbg_setTransform_14c6387ae6829078: function() { return handleError(function (arg0, arg1, arg2, arg3, arg4, arg5, arg6) {
        ...
        __wbg_set_globalCompositeOperation_b9e0baf39ae609ac: function() { return handleError(function (arg0, arg1, arg2) {
            arg0.globalCompositeOperation = getStringFromWasm0(arg1, arg2);
        }, arguments); },
        __wbg_set_height_281ab7665c19410b: function(arg0, arg1) {
            arg0.height = arg1 >>> 0;
        },
        __wbg_set_imageSmoothingEnabled_cf473510dafe4cdd: function(arg0, arg1) {
    ...
    return {
        __proto__: null,
        "./background_pattern_wasm_bg.js": import0,
    };
}

const BackgroundPatternRendererFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_backgroundpatternrenderer_free(ptr >>> 0, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('background_pattern_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
